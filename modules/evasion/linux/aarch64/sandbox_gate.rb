...
class MetasploitModule < Msf::Evasion
  ...
  include Msf::Payload::Linux::Aarch64::SandboxEvasion

  def initialize(info = {})
    super(
      update_info(
        info,
        'Name' => 'Linux AArch64 Sandbox Environment Gate',
        'Description' => %q{
          Generates a Linux AArch64 ELF whose entry point is a pre-execution
  ...
  def run
    ...
    final_elf = Msf::Util::EXE.to_linux_aarch64_elf(framework, combined)
