...
class MetasploitModule < Msf::Evasion
  ...
  include Msf::Payload::Linux::X86::SandboxEvasion

  def initialize(info = {})
    super(
      update_info(
        info,
        'Name' => 'Linux x86 Sandbox Environment Gate',
        'Description' => %q{
          Generates a Linux x86 ELF whose entry point is a pre-execution
  ...
  def run
    ...
    final_elf = Msf::Util::EXE.to_linux_x86_elf(framework, combined)
